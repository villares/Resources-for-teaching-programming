...
pyp5js (pyodide or transcrypt mode)| [p5.js](https://p5js.org/) | [Pyodide](https://luxapodular.github.io/Py5.js/) (Python 3) or [Transcrypt](https://transcrypt.org/documentation) | complete | Python, JavaScript & p5.js |  web ready sketches! very p5.js compatible & pyodide makes it very Python compatible | [Experimental](https://berinhard.github.io/pyp5js/pyodide/), p5.js features only (as opposed to Processing Java/Python modes) |
...
[py5](http://py5.ixora.io/) | [Processing Java 4](https://github.com/processing/processing4) via [JPype](https://jpype.readthedocs.io/en/latest/) |  Python 3 | complete | Python & Java (maybe not that easy) | truly Python compatible, can be used on Jupyter notebooks, very compatible with Processing Java | still experimental, not all traditional Processing libraries might work, new names |
