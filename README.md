...
[p5py](https://github.com/p5py/p5) | Based on OpenGL (incomplete), with experimental Skia backend |  Python 3 | complete | Python only | truly Python compatible, no Java/JVM dependency | Inclomplete, with last release in Dec 2023, no access to Processing Java libraries  |
