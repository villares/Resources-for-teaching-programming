...
[p5py](https://github.com/p5py/p5) | a new inplementation (incomplete), will tap into OpenGl and Skia |  Python 3 | complete | Python only | truly Python compatible, no Java/JVM dependency | New snake_case names, experimental, still incomplete, no access to Processing Java libraries  |
